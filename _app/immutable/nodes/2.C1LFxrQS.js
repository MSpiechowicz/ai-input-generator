import"../chunks/CWj6FrbW.js";import{i as Ie}from"../chunks/BkPyvcLt.js";import{n as D,z as N,ag as Ae,a4 as be,a5 as we,a as Vn,a6 as J,a7 as Gn,m as Wn,aA as De,D as G,o as re,P as w,am as Ee,A as Jn,B as Qn,C as Ce,F as ne,y as F,a9 as Me,ad as Kn,G as Re,v as _e,I as Yn,aB as te,ah as Oe,L as Zn,aC as ce,aD as Se,aE as pe,aw as Xn,aF as se,i as et,aG as nt,aH as tt,aI as ot,x as it,aJ as at,aa as ze,_ as E,aK as rt,ae as st,ac as lt,q as ke,p as ct,aL as pt,aM as dt,aN as ut,aO as mt,aP as gt,aQ as ft,e as vt,K as ht,ao as yt,Z as U,X as S,a0 as y,a1 as f,V as de,W as K,an as bt,Y as z,$ as L,a2 as P,aR as wt,ay as H,aS as Ct,u as oe,aT as St,az as kt}from"../chunks/XA1JBLH8.js";import{s as M,d as q,a as Pt}from"../chunks/w9__UJwA.js";import{i as _,b as xt}from"../chunks/DDLBUDaC.js";function Le(e){D&&N(e)!==null&&Ae(e)}let Pe=!1;function $e(){Pe||(Pe=!0,document.addEventListener("reset",e=>{Promise.resolve().then(()=>{var n;if(!e.defaultPrevented)for(const t of e.target.elements)(n=t.__on_r)==null||n.call(t)})},{capture:!0}))}function Ut(e){var n=Vn,t=J;be(null),we(null);try{return e()}finally{be(n),we(t)}}function Tt(e,n,t,o=t){e.addEventListener(n,()=>Ut(t));const a=e.__on_r;a?e.__on_r=()=>{a(),o(!0)}:e.__on_r=()=>o(!0),$e()}function It(e,n){return n}function At(e,n,t,o){for(var a=[],i=n.length,r=0;r<i;r++)tt(n[r].e,a,!0);var s=i>0&&a.length===0&&t!==null;if(s){var g=t.parentNode;Ae(g),g.append(t),o.clear(),j(e,n[0].prev,n[i-1].next)}ot(a,()=>{for(var m=0;m<i;m++){var d=n[m];s||(o.delete(d.k),j(e,d.prev,d.next)),it(d.e,!s)}})}function Q(e,n,t,o,a,i=null){var r=e,s={flags:n,items:new Map,first:null},g=(n&De)!==0;if(g){var m=e;r=D?G(N(m)):m.appendChild(Gn())}D&&re();var d=null,h=!1,c=Ee(()=>{var u=t();return et(u)?u:u==null?[]:Oe(u)});Wn(()=>{var u=w(c),l=u.length;if(h&&l===0)return;h=l===0;let x=!1;if(D){var I=Jn(r)===Qn;I!==(l===0)&&(r=Ce(),G(r),ne(!1),x=!0)}if(D){for(var v=null,k,T=0;T<l;T++){if(F.nodeType===Me&&F.data===Kn){r=F,x=!0,ne(!1);break}var b=u[T],C=o(b,T);k=je(F,s,v,null,b,C,T,a,n,t),s.items.set(C,k),v=k}l>0&&G(Ce())}D||Dt(u,s,r,a,n,o,t),i!==null&&(l===0?d?Re(d):d=_e(()=>i(r)):d!==null&&Yn(d,()=>{d=null})),x&&ne(!0),w(c)}),D&&(r=F)}function Dt(e,n,t,o,a,i,r){var ge,fe,ve,he;var s=(a&nt)!==0,g=(a&(ce|pe))!==0,m=e.length,d=n.items,h=n.first,c=h,u,l=null,x,I=[],v=[],k,T,b,C;if(s)for(C=0;C<m;C+=1)k=e[C],T=i(k,C),b=d.get(T),b!==void 0&&((ge=b.a)==null||ge.measure(),(x??(x=new Set)).add(b));for(C=0;C<m;C+=1){if(k=e[C],T=i(k,C),b=d.get(T),b===void 0){var Z=c?c.e.nodes_start:t;l=je(Z,n,l,l===null?n.first:l.next,k,T,C,o,a,r),d.set(T,l),I=[],v=[],c=l.next;continue}if(g&&Et(b,k,C,a),(b.e.f&te)!==0&&(Re(b.e),s&&((fe=b.a)==null||fe.unfix(),(x??(x=new Set)).delete(b))),b!==c){if(u!==void 0&&u.has(b)){if(I.length<v.length){var V=v[0],$;l=V.prev;var me=I[0],X=I[I.length-1];for($=0;$<I.length;$+=1)xe(I[$],V,t);for($=0;$<v.length;$+=1)u.delete(v[$]);j(n,me.prev,X.next),j(n,l,me),j(n,X,V),c=V,l=X,C-=1,I=[],v=[]}else u.delete(b),xe(b,c,t),j(n,b.prev,b.next),j(n,b,l===null?n.first:l.next),j(n,l,b),l=b;continue}for(I=[],v=[];c!==null&&c.k!==T;)(c.e.f&te)===0&&(u??(u=new Set)).add(c),v.push(c),c=c.next;if(c===null)continue;b=c}I.push(b),l=b,c=b.next}if(c!==null||u!==void 0){for(var B=u===void 0?[]:Oe(u);c!==null;)(c.e.f&te)===0&&B.push(c),c=c.next;var ee=B.length;if(ee>0){var qn=(a&De)!==0&&m===0?t:null;if(s){for(C=0;C<ee;C+=1)(ve=B[C].a)==null||ve.measure();for(C=0;C<ee;C+=1)(he=B[C].a)==null||he.fix()}At(n,B,qn,d)}}s&&Zn(()=>{var ye;if(x!==void 0)for(b of x)(ye=b.a)==null||ye.apply()}),J.first=n.first&&n.first.e,J.last=l&&l.e}function Et(e,n,t,o){(o&ce)!==0&&Se(e.v,n),(o&pe)!==0?Se(e.i,t):e.i=t}function je(e,n,t,o,a,i,r,s,g,m){var d=(g&ce)!==0,h=(g&at)===0,c=d?h?Xn(a,!1,!1):se(a):a,u=(g&pe)===0?r:se(r),l={i:u,v:c,k:i,a:null,e:null,prev:t,next:o};try{return l.e=_e(()=>s(e,c,u,m),D),l.e.prev=t&&t.e,l.e.next=o&&o.e,t===null?n.first=l:(t.next=l,t.e.next=l.e),o!==null&&(o.prev=l,o.e.prev=l.e),l}finally{}}function xe(e,n,t){for(var o=e.next?e.next.e.nodes_start:t,a=n?n.e.nodes_start:t,i=e.e.nodes_start;i!==o;){var r=ze(i);a.before(i),i=r}}function j(e,n,t){n===null?e.first=t:(n.next=t,n.e.next=t&&t.e),t!==null&&(t.prev=n,t.e.prev=n&&n.e)}function Mt(e,n,t=!1,o=!1,a=!1){var i=e,r="";E(()=>{var s=J;if(r===(r=n()??"")){D&&re();return}if(s.nodes_start!==null&&(rt(s.nodes_start,s.nodes_end),s.nodes_start=s.nodes_end=null),r!==""){if(D){F.data;for(var g=re(),m=g;g!==null&&(g.nodeType!==Me||g.data!=="");)m=g,g=ze(g);if(g===null)throw st(),lt;ke(F,m),i=G(g);return}var d=r+"";t?d=`<svg>${d}</svg>`:o&&(d=`<math>${d}</math>`);var h=ct(d);if((t||o)&&(h=N(h)),ke(N(h),h.lastChild),t||o)for(;N(h);)i.before(N(h));else i.before(h)}})}function Rt(e,n,t){var o=e==null?"":""+e;return o===""?null:o}function Y(e,n,t,o,a,i){var r=e.__className;if(D||r!==t||r===void 0){var s=Rt(t);(!D||s!==e.getAttribute("class"))&&(s==null?e.removeAttribute("class"):e.className=s),e.__className=t}return i}const _t=Symbol("is custom element"),Ot=Symbol("is html");function zt(e){if(D){var n=!1,t=()=>{if(!n){if(n=!0,e.hasAttribute("value")){var o=e.value;O(e,"value",null),e.value=o}if(e.hasAttribute("checked")){var a=e.checked;O(e,"checked",null),e.checked=a}}};e.__on_r=t,gt(t),$e()}}function Lt(e,n){var t=Fe(e);t.value===(t.value=n??void 0)||e.value===n&&(n!==0||e.nodeName!=="PROGRESS")||(e.value=n??"")}function O(e,n,t,o){var a=Fe(e);D&&(a[n]=e.getAttribute(n),n==="src"||n==="srcset"||n==="href"&&e.nodeName==="LINK")||a[n]!==(a[n]=t)&&(n==="loading"&&(e[pt]=t),t==null?e.removeAttribute(n):typeof t!="string"&&$t(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function Fe(e){return e.__attributes??(e.__attributes={[_t]:e.nodeName.includes("-"),[Ot]:e.namespaceURI===dt})}var Ue=new Map;function $t(e){var n=Ue.get(e.nodeName);if(n)return n;Ue.set(e.nodeName,n=[]);for(var t,o=e,a=Element.prototype;a!==o;){t=mt(o);for(var i in t)t[i].set&&n.push(i);o=ut(o)}return n}function He(e,n,t=n){var o=ft();Tt(e,"input",a=>{var i=a?e.defaultValue:e.value;if(i=ie(e)?ae(i):i,t(i),o&&i!==(i=n())){var r=e.selectionStart,s=e.selectionEnd;e.value=i??"",s!==null&&(e.selectionStart=r,e.selectionEnd=Math.min(s,e.value.length))}}),(D&&e.defaultValue!==e.value||vt(n)==null&&e.value)&&t(ie(e)?ae(e.value):e.value),ht(()=>{var a=n();ie(e)&&a===ae(e.value)||e.type==="date"&&!a&&!e.value||a!==e.value&&(e.value=a??"")})}function ie(e){var n=e.type;return n==="number"||n==="range"}function ae(e){return e===""?null:+e}function jt(e){var n=se(0);return function(){return arguments.length===1?(yt(n,w(n)+1),arguments[0]):(w(n),e())}}var Ft=U('<a target="_blank" rel="noopener noreferrer" class="cursor-pointer font-bold tracking-wider uppercase hover:underline hover:underline-offset-4 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:outline-none"> </a>'),Ht=U('<p class="hidden font-bold tracking-wider uppercase md:block"> </p>'),Nt=U('<footer class="bg-black text-white"><div class="p-6"><div class="flex flex-col items-center justify-center gap-2 md:flex-row"></div></div></footer>');function Bt(e){const n=[{label:"BUILT WITH SVELTE 5",link:"https://svelte.dev/"},{label:"•",link:null},{label:"MADE BY MACIEJ SPIECHOWICZ",link:"https://mspiechowicz.com"}];var t=Nt(),o=y(t),a=y(o);Q(a,5,()=>n,It,(i,r)=>{var s=de(),g=K(s);{var m=h=>{var c=Ft(),u=y(c,!0);f(c),E(()=>{O(c,"href",w(r).link),M(u,w(r).label)}),S(h,c)},d=h=>{var c=Ht(),u=y(c,!0);f(c),E(()=>M(u,w(r).label)),S(h,c)};_(g,h=>{w(r).link?h(m):h(d,!1)})}S(i,s)}),f(a),f(o),f(t),S(e,t)}var qt=U(`<header class="my-6 p-4 md:my-8"><div class="flex flex-col items-center justify-center gap-2"><h1 class="mb-4 text-center text-5xl font-extrabold">AI INPUT GENERATOR</h1> <p class="max-w-[60ch] text-center text-lg font-bold">TRANSFORM YOUR BASIC PROMPTS INTO PROFESSIONAL, COMPREHENSIVE AI INPUTS WITH EXPERT-CRAFTED
			TEMPLATES</p></div></header>`);function Vt(e){var n=qt();S(e,n)}const Ne="angular",Be="Angular",qe="Angular, Components, Services, RxJS",Ve=["ANGULAR","COMPONENTS","SERVICES","RXJS"],Ge=["angular-core-rules.md"],Gt={id:Ne,name:Be,description:qe,keywords:Ve,promptFiles:Ge},Wt=Object.freeze(Object.defineProperty({__proto__:null,default:Gt,description:qe,id:Ne,keywords:Ve,name:Be,promptFiles:Ge},Symbol.toStringTag,{value:"Module"})),We="database",Je="Database",Qe="SQL, NoSQL, Schema Design, Queries, Optimization",Ke=["SQL","NOSQL","SCHEMA","QUERIES","STORAGE"],Ye=["database-core-rules.md"],Jt={id:We,name:Je,description:Qe,keywords:Ke,promptFiles:Ye},Qt=Object.freeze(Object.defineProperty({__proto__:null,default:Jt,description:Qe,id:We,keywords:Ke,name:Je,promptFiles:Ye},Symbol.toStringTag,{value:"Module"})),Ze="devops",Xe="DevOps",en="Docker, CI/CD, Cloud Infrastructure",nn=["DOCKER","CI/CD","CLOUD","INFRASTRUCTURE","DEPLOYMENT"],tn=["devops-core-rules.md"],Kt={id:Ze,name:Xe,description:en,keywords:nn,promptFiles:tn},Yt=Object.freeze(Object.defineProperty({__proto__:null,default:Kt,description:en,id:Ze,keywords:nn,name:Xe,promptFiles:tn},Symbol.toStringTag,{value:"Module"})),on="nodejs",an="Node.js",rn="Backend, Express, API Development",sn=["BACKEND","EXPRESS","API","SERVER"],ln=["nodejs-core-rules.md","nodejs-api-patterns.md","nodejs-security.md"],Zt={id:on,name:an,description:rn,keywords:sn,promptFiles:ln},Xt=Object.freeze(Object.defineProperty({__proto__:null,default:Zt,description:rn,id:on,keywords:sn,name:an,promptFiles:ln},Symbol.toStringTag,{value:"Module"})),cn="python",pn="Python",dn="Python, Flask, Backend, Api, REST",un=["PYTHON","FLASK","BACKEND","API","REST"],mn=["python-core-rules.md"],eo={id:cn,name:pn,description:dn,keywords:un,promptFiles:mn},no=Object.freeze(Object.defineProperty({__proto__:null,default:eo,description:dn,id:cn,keywords:un,name:pn,promptFiles:mn},Symbol.toStringTag,{value:"Module"})),gn="react",fn="React",vn="React, Hooks, JSX, Components",hn=["FRONTEND","HOOKS","JSX","COMPONENTS","HTML"],yn=["react-core-rules.md","react-hooks-patterns.md","react-performance.md"],to={id:gn,name:fn,description:vn,keywords:hn,promptFiles:yn},oo=Object.freeze(Object.defineProperty({__proto__:null,default:to,description:vn,id:gn,keywords:hn,name:fn,promptFiles:yn},Symbol.toStringTag,{value:"Module"})),bn="svelte",wn="Svelte",Cn="SvelteKit, Svelte 5, Reactive UI",Sn=["FRONTEND","REACTIVE","UI","COMPONENTS","STORES","HTML"],kn=["svelte5-best-practices.md","svelte5-performance.md","svelte5-small-docs.md","svelte5-runes.md"],io={id:bn,name:wn,description:Cn,keywords:Sn,promptFiles:kn},ao=Object.freeze(Object.defineProperty({__proto__:null,default:io,description:Cn,id:bn,keywords:Sn,name:wn,promptFiles:kn},Symbol.toStringTag,{value:"Module"})),Pn="tailwind",xn="Tailwind",Un="Tailwind CSS, Tailwind UI, Tailwind Components",Tn=["CSS","UI","WEB","COMPONENTS"],In=["tailwind-core-rules.md"],ro={id:Pn,name:xn,description:Un,keywords:Tn,promptFiles:In},so=Object.freeze(Object.defineProperty({__proto__:null,default:ro,description:Un,id:Pn,keywords:Tn,name:xn,promptFiles:In},Symbol.toStringTag,{value:"Module"})),An="ui",Dn="UI Design",En="Interface Design, Components, Systems",Mn=["INTERFACE","COMPONENTS","DESIGN SYSTEMS","VISUAL","LAYOUTS"],Rn=["ui-core-rules.md"],lo={id:An,name:Dn,description:En,keywords:Mn,promptFiles:Rn},co=Object.freeze(Object.defineProperty({__proto__:null,default:lo,description:En,id:An,keywords:Mn,name:Dn,promptFiles:Rn},Symbol.toStringTag,{value:"Module"})),_n="ux",On="UX Design",zn="User Experience, Wireframes, Prototypes",Ln=["USER EXPERIENCE","WIREFRAMES","PROTOTYPES","RESEARCH","TESTING"],$n=["ux-research-methods.md","ux-design-principles.md","ux-accessibility.md"],po={id:_n,name:On,description:zn,keywords:Ln,promptFiles:$n},uo=Object.freeze(Object.defineProperty({__proto__:null,default:po,description:zn,id:_n,keywords:Ln,name:On,promptFiles:$n},Symbol.toStringTag,{value:"Module"})),jn="vue",Fn="Vue",Hn="Vue.js, Nuxt, Composition API, Reactive, Templates",Nn=["VUE","JSX","COMPOSITION API","REACTIVE","TEMPLATES"],Bn=["vue-core-rules.md"],mo={id:jn,name:Fn,description:Hn,keywords:Nn,promptFiles:Bn},go=Object.freeze(Object.defineProperty({__proto__:null,default:mo,description:Hn,id:jn,keywords:Nn,name:Fn,promptFiles:Bn},Symbol.toStringTag,{value:"Module"})),fo=`# Angular Core Rules
...
`,So=`# React Performance Guidelines
...
`,Po=`# Svelte 5 Performance Guidelines
...
9. **Component Documentation** with usage examples and prop descriptions
10. **Development Setup** with proper configuration and tooling
`,Eo=`<svg xmlns="http://www.w3.org/2000/svg"
     fill="none"
     viewBox="0 0 242 256">
  <g clip-path="url(#a)">
    <mask id="b"
...
`,Oo=`<?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
...
</svg>`,Ho=`<?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
<svg width="800px" height="800px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">\r
...
</svg>`,p=bt({searchQuery:"",input:"",output:"",topics:[],selectedTopics:[],filteredTopics:[],defaultTopicCount:6,topicCountIncrement:6,promptCopied:!1}),No=Object.assign({"./prompts/angular/config.json":Wt,"./prompts/database/config.json":Qt,"./prompts/devops/config.json":Yt,"./prompts/nodejs/config.json":Xt,"./prompts/python/config.json":no,"./prompts/react/config.json":oo,"./prompts/svelte/config.json":ao,"./prompts/tailwind/config.json":so,"./prompts/ui/config.json":co,"./prompts/ux/config.json":uo,"./prompts/vue/config.json":go}),Bo=Object.assign({"./prompts/angular/angular-core-rules.md":fo,"./prompts/database/database-core-rules.md":vo,"./prompts/devops/devops-core-rules.md":ho,"./prompts/nodejs/nodejs-core-rules.md":yo,"./prompts/python/python-core-rules.md":bo,"./prompts/react/react-core-rules.md":wo,"./prompts/react/react-hooks-patterns.md":Co,"./prompts/react/react-performance.md":So,"./prompts/svelte/svelte5-best-practices.md":ko,"./prompts/svelte/svelte5-performance.md":Po,"./prompts/svelte/svelte5-runes.md":xo,"./prompts/svelte/svelte5-small-docs.md":Uo,"./prompts/tailwind/tailwind-core-rules.md":To,"./prompts/ui/ui-core-rules.md":Io,"./prompts/ux/ux-design-principles.md":Ao,"./prompts/vue/vue-core-rules.md":Do}),qo=Object.assign({"./prompts/angular/logo.svg":Eo,"./prompts/database/logo.svg":Mo,"./prompts/devops/logo.svg":Ro,"./prompts/nodejs/logo.svg":_o,"./prompts/python/logo.svg":Oo,"./prompts/react/logo.svg":zo,"./prompts/svelte/logo.svg":Lo,"./prompts/tailwind/logo.svg":$o,"./prompts/ui/logo.svg":jo,"./prompts/ux/logo.svg":Fo,"./prompts/vue/logo.svg":Ho}),R={};for(const[e,n]of Object.entries(No)){const t=e.split("/")[2],o=n.default;R[t]={...o,id:t}}for(const[e,n]of Object.entries(qo)){const t=e.split("/")[2];R[t]&&(R[t].logo=n)}const W={};for(const[e,n]of Object.entries(Bo)){const t=e.split("/"),o=t[2],a=t[3];W[o]||(W[o]={}),W[o][a]=n}function Vo(){const n=Object.keys(R).map(t=>R[t]);p.topics=n,p.filteredTopics=n}function Te(e){const n=R[e];if(!n||!n.promptFiles)return"";const t=W[e]||{},o=[];for(const a of n.promptFiles)t[a]&&o.push(t[a]);return o.join(`
...
Focus on creating a cohesive solution that leverages the strengths of each domain while addressing potential integration challenges.`}}var Go=U('<div class="mb-6 flex flex-col gap-0"><h2 class="mb-3 text-3xl font-extrabold"> </h2> <p class="text-lg font-bold"> </p></div>');function ue(e,n){z(n,!0);var t=Go(),o=y(t),a=y(o,!0);f(o);var i=P(o,2),r=y(i,!0);f(i),f(t),E(s=>{M(a,n.title),O(i,"id",`section-description-${s??""}`),M(r,n.description)},[()=>n.title.toLowerCase().replace(/\s+/g,"-")]),S(e,t),L()}var Wo=U('<section><!> <label for="project-request" class="sr-only">Enter your project request</label> <textarea id="project-request" rows="8" aria-label="Enter your project request" aria-describedby="request-instructions"></textarea> <div id="request-instructions" class="sr-only">Describe what you want to build or accomplish. Select at least one project type first.</div></section>');function Jo(e,n){z(n,!0);const t=H(()=>p.selectedTopics.length===0);var o=Wo(),a=y(o);ue(a,{title:"ENTER YOUR REQUEST",description:"DESCRIBE WHAT YOU WANT TO BUILD OR ACCOMPLISH"});var i=P(a,4);Le(i),i.__input=()=>{p.output=le(p.selectedTopics.map(r=>r.id),p.input)},wt(2),f(o),E(()=>{Y(i,1,`brutalism brutalism-shadow-medium focus:ring-accent-tertiary w-full bg-white p-4 font-bold focus:ring-2 focus:ring-offset-2 focus:outline-none ${w(t)?"opacity-50":""}`),O(i,"placeholder",w(t)?"SELECT AT LEAST ONE PROJECT TYPE FIRST...":"EXAMPLE: BUILD A TODO APP WITH DRAG-AND-DROP, DARK MODE, AND CLOUD SYNC"),i.disabled=w(t)}),He(i,()=>p.input,r=>p.input=r),S(e,o),L()}q(["input"]);var Qo=U('<section class="mt-8"><!> <div class="flex flex-1 flex-col gap-6"><textarea id="generated-prompt" class="brutalism brutalism-shadow-medium focus:ring-accent-tertiary min-h-[534px] w-full p-4 focus:ring-2 focus:ring-offset-2 focus:outline-none" readonly="" rows="20" aria-label="Generated AI prompt - click to select all" aria-describedby="prompt-instructions"></textarea> <div id="prompt-instructions" class="sr-only">Generated AI prompt. Use the buttons below to copy or select all text.</div> <div class="grid grid-cols-1 gap-4 md:grid-cols-2"><button class="brutalism brutalism-shadow-medium brutalism-transition bg-accent-tertiary h-14 w-full font-bold !text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:outline-none" aria-label="Copy generated prompt to clipboard"> </button> <button class="brutalism brutalism-shadow-medium brutalism-transition bg-accent focus:ring-accent-tertiary h-14 w-full font-bold focus:ring-2 focus:ring-offset-2 focus:outline-none" aria-label="Select all text in the generated prompt">SELECT ALL TEXT</button></div></div></section>');function Ko(e,n){z(n,!0);let t;const o=H(()=>p.output);var a=Qo(),i=y(a);ue(i,{title:"GENERATED PROMPT",description:"YOUR ENHANCED, PROFESSIONAL AI PROMPT"});var r=P(i,2),s=y(r);Le(s),xt(s,c=>t=c,()=>t);var g=P(s,4),m=y(g);m.__click=()=>{p.promptCopied=!0,navigator.clipboard.writeText(w(o)),setTimeout(()=>{p.promptCopied=!1},2e3)};var d=y(m,!0);f(m);var h=P(m,2);h.__click=()=>{t.select()},f(g),f(r),f(a),E(()=>{Lt(s,w(o)),M(d,p.promptCopied?"✓ PROMPT COPIED!":"COPY TO CLIPBOARD")}),S(e,a),L()}q(["click"]);var Yo=U('<div class="h-10 w-1.5 bg-black md:h-1.5 md:w-15" aria-hidden="true"></div>'),Zo=U('<div class="flex flex-col items-center justify-center gap-4 lg:flex-row"><div> </div> <span class="text-lg font-bold"> </span></div> <!>',1),Xo=U('<section class="bg-accent border-primary border-y-4 p-4" role="progressbar" aria-label="Progress through the AI prompt generation process" aria-valuemin="1" aria-valuemax="3"><div class="flex flex-col items-center justify-center gap-4 md:flex-row md:gap-6"></div></section>');function ei(e,n){z(n,!0);const t=H(()=>[{label:"SELECT TOPICS",active:!0},{label:"ENTER PROMPT",active:p.selectedTopics.length>0},{label:"COPY RESULT",active:p.promptCopied}]);var o=Xo(),a=y(o);Q(a,23,()=>w(t),i=>i.label,(i,r,s)=>{var g=Zo(),m=K(g),d=y(m),h=y(d,!0);f(d);var c=P(d,2),u=y(c,!0);f(c),f(m);var l=P(m,2);{var x=I=>{var v=Yo();S(I,v)};_(l,I=>{w(s)<w(t).length-1&&I(x)})}E(()=>{Y(d,1,`brutalism brutalism-shadow-medium w-10 bg-white px-3 py-1 text-lg font-bold ${w(r).active?"!bg-accent-tertiary !text-white":""}`),O(d,"aria-current",w(r).active?"step":void 0),M(h,w(s)+1),M(u,w(r).label)}),S(i,g)}),f(a),f(o),E(i=>O(o,"aria-valuenow",i),[()=>w(t).filter(i=>i.active).length]),S(e,o),L()}var ni=U('<div class="brutalism brutalism-shadow-medium bg-accent w-full p-4 font-bold" role="alert" aria-live="polite"><div class="flex gap-3 w-full"><span class="text-xl" aria-hidden="true">🔍</span> <div><h3 class="text-xl font-bold mb-2">NO PROJECTS FOUND</h3> <p class="text-sm">TRY A DIFFERENT SEARCH TERM OR CLEAR THE SEARCH</p></div></div></div>');function ti(e,n){var t=de(),o=K(t);{var a=i=>{var r=ni();S(i,r)};_(o,i=>{n.totalFilteredCount===0&&i(a)})}S(e,t)}var oi=(e,n,t)=>n.toggleTopic(t()),ii=U('<div class="h-8 w-8 [&amp;>svg]:h-8 [&amp;>svg]:w-8"><!></div>'),ai=U('<div class="brutalism brutalism-shadow-small bg-white p-1"><span class="text-sm font-bold"> </span></div>'),ri=U('<div class="absolute top-3 right-3" aria-hidden="true"><div class="text-2xl font-bold">✓</div></div>'),si=U('<button type="button"><div class="flex w-full flex-col text-left"><div class="flex items-center gap-3"><!> <h3 class="text-xl font-bold"> </h3></div> <div class="mt-4 flex flex-wrap gap-3"></div> <!></div></button>'),li=U('<div class="grid gap-4"></div>');function ci(e,n){z(n,!0);var t=li();Q(t,21,()=>n.projectsToDisplay,([o,a])=>o,(o,a)=>{var i=H(()=>Ct(w(a),2));let r=()=>w(i)[1];var s=si();s.__click=[oi,n,r];var g=y(s),m=y(g),d=y(m);{var h=v=>{var k=ii(),T=y(k);Mt(T,()=>r().logo),f(k),S(v,k)};_(d,v=>{r().logo&&v(h)})}var c=P(d,2),u=y(c,!0);f(c),f(m);var l=P(m,2);Q(l,20,()=>r().keywords.slice(0,4),v=>v,(v,k)=>{var T=ai(),b=y(T),C=y(b,!0);f(b),f(T),E(Z=>M(C,Z),[()=>String(k).toUpperCase()]),S(v,T)}),f(l);var x=P(l,2);{var I=v=>{var k=ri();S(v,k)};_(x,v=>{p.selectedTopics.includes(r())&&v(I)})}f(g),f(s),E((v,k,T)=>{Y(s,1,`brutalism brutalism-shadow-medium brutalism-transition focus:ring-accent-tertiary relative min-w-full focus:ring-2 focus:ring-offset-2 focus:outline-none ${v??""} p-4`),O(s,"aria-pressed",k),O(s,"aria-label",`Select ${r().name??""} topic`),M(u,T)},[()=>p.selectedTopics.includes(r())?"bg-accent":"",()=>p.selectedTopics.includes(r()),()=>String(r().name).toUpperCase()]),S(o,s)}),f(t),S(e,t),L()}q(["click"]);var A=jt(()=>p),pi=U('<button type="button" class="brutalism brutalism-shadow-medium brutalism-transition bg-button-red absolute top-2 right-4 h-6 w-6 p-3 font-bold focus:ring-2 focus:ring-white focus:ring-offset-2 focus:outline-none" aria-label="Clear search">X</button>'),di=U('<div class="mb-6"><div class="flex flex-col gap-4 md:flex-row"><div class="relative flex-1"><label for="search-input" class="sr-only">Search project types</label> <input id="search-input" type="text" class="brutalism brutalism-shadow-medium focus:ring-accent-tertiary w-full bg-white py-3 !pr-20 !pl-4 focus:ring-2 focus:ring-offset-2 focus:outline-none" placeholder="SEARCH TOPICS..." aria-label="Search project types"/> <!></div> <button type="button" aria-label="Clear all selected topics">CLEAR ALL</button></div></div>');function ui(e,n){z(n,!1);function t(){A(A().selectedTopics=[]),A(A().output=""),A(A().input="")}function o(){A(A().searchQuery=""),A(A().defaultTopicCount=6)}function a(){return A().selectedTopics.length>0?"brutalism-transition":""}function i(){return A().selectedTopics.length===0?"opacity-50":""}Ie();var r=di(),s=y(r),g=y(s),m=P(y(g),2);zt(m);var d=P(m,2);{var h=u=>{var l=pi();l.__click=o,S(u,l)};_(d,u=>{A().searchQuery&&u(h)})}f(g);var c=P(g,2);c.__click=t,f(s),f(r),E((u,l)=>{Y(c,1,`brutalism brutalism-shadow-medium ${u??""} ${l??""} bg-button-red px-4 py-2 font-bold text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:outline-none`),c.disabled=A().selectedTopics.length===0},[a,i],Ee),He(m,()=>A().searchQuery,u=>A(A().searchQuery=u)),S(e,r),L()}q(["click"]);var mi=U('<div class="mt-6 text-center"><button type="button" class="brutalism brutalism-shadow-medium brutalism-transition bg-accent-tertiary h-14 w-full p-4 font-bold !text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:outline-none" aria-label="Show more project types"> </button></div>');function gi(e,n){z(n,!0);var t=de(),o=K(t);{var a=i=>{var r=mi(),s=y(r);s.__click=function(...m){var d;(d=n.showMoreProjects)==null||d.apply(this,m)};var g=y(s);f(s),f(r),E(m=>M(g,`SHOW ${m??""} MORE (${n.totalFilteredCount-p.defaultTopicCount} REMAINING)`),[()=>Math.min(6,n.totalFilteredCount-p.defaultTopicCount)]),S(i,r)};_(o,i=>{n.hasMoreProjects&&i(a)})}S(e,t),L()}q(["click"]);var fi=U("<section><!> <!> <!> <!> <!></section>");function vi(e,n){z(n,!0),oe(()=>{Vo()});const t=H(()=>Object.entries(p.filteredTopics).slice(0,p.defaultTopicCount)),o=H(()=>Object.keys(p.filteredTopics).length>p.defaultTopicCount),a=H(()=>Object.keys(p.filteredTopics).length);function i(u){if(p.selectedTopics.includes(u)){const l=p.selectedTopics.filter(x=>x!==u);p.selectedTopics=l,p.output=le(p.selectedTopics.map(x=>x.id),p.input)}else{const l=[...p.selectedTopics,u];p.selectedTopics=l,p.output=le(p.selectedTopics.map(x=>x.id),p.input)}}function r(){p.defaultTopicCount+=p.topicCountIncrement}oe(()=>{if(p.searchQuery.trim()==="")p.filteredTopics=p.topics;else{const u=p.searchQuery.toLowerCase();p.filteredTopics=p.topics.filter(l=>l.name.toLowerCase().includes(u)||l.description.toLowerCase().includes(u)||l.keywords.some(x=>x.toLowerCase().includes(u))||l.id.toLowerCase().includes(u))}}),oe(()=>{p.searchQuery&&(p.defaultTopicCount=6)});var s=fi(),g=y(s);ue(g,{title:"CHOOSE TOPIC AREAS",description:"SELECT ONE OR MORE TOPICS FOR YOUR REQUEST"});var m=P(g,2);ui(m,{});var d=P(m,2);ci(d,{get projectsToDisplay(){return w(t)},toggleTopic:i});var h=P(d,2);gi(h,{get hasMoreProjects(){return w(o)},showMoreProjects:r,get totalFilteredCount(){return w(a)}});var c=P(h,2);ti(c,{get totalFilteredCount(){return w(a)}}),f(s),S(e,s),L()}var hi=U('<meta name="description" content="Transform basic requests into professional AI prompts with expert templates for different project types."/>'),yi=U('<div class="min-h-screen"><a href="#main-content" class="focus:bg-accent sr-only uppercase focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:font-bold focus:text-black">SKIP TO MAIN CONTENT</a> <!> <!> <main id="main-content"><div class="grid grid-cols-1 gap-8 p-8 md:grid-cols-2"><div class="flex flex-col gap-12"><!></div> <div class="flex flex-1 flex-col"><!> <div aria-live="polite" aria-atomic="true" class="sr-only"><!></div> <!></div></div></main> <!></div>');function Pi(e,n){z(n,!1),Ie();var t=yi();Pt(v=>{var k=hi();St.title="AI Input Generator - Transform Your Prompts",S(v,k)});var o=P(y(t),2);Vt(o);var a=P(o,2);ei(a,{});var i=P(a,2),r=y(i),s=y(r),g=y(s);vi(g,{}),f(s);var m=P(s,2),d=y(m);Jo(d,{});var h=P(d,2),c=y(h);{var u=v=>{var k=kt("Generated prompt is ready");S(v,k)};_(c,v=>{p.input&&p.output&&p.selectedTopics.length>0&&v(u)})}f(h);var l=P(h,2);{var x=v=>{Ko(v,{})};_(l,v=>{p.input&&p.output&&p.selectedTopics.length>0&&v(x)})}f(m),f(r),f(i);var I=P(i,2);Bt(I),f(t),S(e,t),L()}export{Pi as component};
